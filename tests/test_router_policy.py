...
class TaskClassifierKindTests(unittest.TestCase):
    ...
    def test_agent_creation_task(self):
    ...
    def test_legal_analysis_arabic(self):
    ...
    def test_legal_analysis_english_with_sama(self):
        profile = classify_task("Is this legal under SAMA regulation?")
        self.assertEqual(profile.kind, TaskKind.LEGAL_ANALYSIS)

    def test_critical_decision_default(self):
        profile = classify_task("Production payment auth fix")
        self.assertEqual(profile.risk, "critical")

    def test_long_context_analysis(self):
    ...
    def test_default_fast_draft(self):
    ...
    def test_estimated_context_tokens_scales_past_floor(self):
...
class ChooseRouteTests(unittest.TestCase):
    ...
    def test_arabic_legal_routes_to_anthropic(self):
        route = choose_route(
            _profile(
    ...
    def test_multimodal_high_risk_routes_to_openai_with_reviewer(self):
        route = choose_route(
            _profile(
    ...
    def test_multimodal_low_risk_routes_to_openai_no_reviewer(self):
        route = choose_route(
            _profile(
    ...
    def test_coding_routes_to_modal_mihwar(self):
...
class BuildExecutionPlanTests(unittest.TestCase):
    ...
    def test_legal_analysis_includes_legal_claim_discipline(self):
    ...
    def test_code_execution_evidence_step_present(self):
