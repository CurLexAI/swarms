...
class CategoryDetectionTests(unittest.TestCase):
    ...
    def test_commercial_registration(self):
...
class MaskingTests(unittest.TestCase):
    ...
    def test_redact_replaces_raw_value(self):
...
class WordBoundaryTests(unittest.TestCase):
    def test_eleven_digits_does_not_match_ten_digit_id(self):
    ...
    def test_iban_does_not_double_match_as_10_digit(self):
    ...
    def test_short_digit_run_does_not_match(self):
        self.assertEqual(detect_ksa_pii("Number 12345"), ())

    def test_word_boundary_inside_alpha(self):
...
class AntiCollisionTests(unittest.TestCase):
    def test_iban_is_returned_when_both_iban_and_digits_present(self):
        hits = detect_ksa_pii(
    ...
    def test_mobile_and_national_id_distinct(self):
...
class EdgeCaseTests(unittest.TestCase):
    ...
    def test_non_string_returns_empty(self):
        ...
        self.assertEqual(detect_ksa_pii(None), ())  # type: ignore[arg-type]
        self.assertEqual(detect_ksa_pii(12345), ())  # type: ignore[arg-type]

    def test_no_pii_text(self):
        self.assertFalse(has_ksa_pii("This is benign text."))

    def test_has_ksa_pii_truthy(self):
